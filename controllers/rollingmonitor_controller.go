...
const MonitorFinalizer = "monitored/finalizer"

//+kubebuilder:rbac:groups=demo.vgalaxy,resources=rollingmonitors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo.vgalaxy,resources=rollingmonitors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo.vgalaxy,resources=rollingmonitors/finalizers,verbs=update
